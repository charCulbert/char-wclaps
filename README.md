...
WCLAP plug-ins for browser hosts. Download an archive and load it in a host
that supports WCLAP.

| Plug-in | Description | Download | Source |
| --- | --- | --- | --- |
...
The repository's MIT license covers this README and other original repository
metadata. Plug-ins and third-party components retain their own licenses.
